...
test("public Travail/Services/Home pages (FR/EN) render server-side: 200, no admin headers, even with no D1 data yet", async () => {
  for (const path of ["/travail", "/en/work", "/services", "/en/services", "/", "/en"]) {
